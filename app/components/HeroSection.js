...
export default function HeroSection() {
  return (
    <header className="relative min-h-[70vh] flex items-center justify-between px-[2%] lg:px-[10%] overflow-hidden bg-gradient-to-br from-blue-100 via-white to-purple-100">
      {/* Glowing Blobs */}
